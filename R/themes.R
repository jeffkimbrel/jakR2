...
jak_theme <- function(base_size = 10,
  ...
  ggplot2::theme_bw(base_size = base_size,
    ...
    ggplot2::theme(
      line = ggplot2::element_line(color = base_color, linewidth = 0.2, linetype = 1, lineend = "butt"),
      rect = ggplot2::element_rect(fill = "transparent", color = base_color, linewidth = 0.5, linetype = 1),
      ...
      legend.box.background = ggplot2::element_rect(fill = "transparent", color = base_color, linewidth = 0.2),
